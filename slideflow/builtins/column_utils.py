...
def abbreviate_number_columns(
    df: pd.DataFrame, columns_to_abbreviate: List[str]
) -> pd.DataFrame:
...
def round_numbers(
    df: pd.DataFrame, columns_to_round: List[str], decimal_places: int = 2
) -> pd.DataFrame:
