...
builtin_function_registry.register_function(
    "create_dynamic_colors", create_dynamic_colors
)
builtin_function_registry.register_function(
    "create_growth_colors", create_growth_colors
)
builtin_function_registry.register_function(
    "create_performance_colors", create_performance_colors
)
builtin_function_registry.register_function(
    "growth_color_function", growth_color_function
)
builtin_function_registry.register_function(
    "performance_color_function", performance_color_function
)
builtin_function_registry.register_function(
    "create_traffic_light_colors", create_traffic_light_colors
)
builtin_function_registry.register_function(
    "abbreviate_number_columns", abbreviate_number_columns
)
builtin_function_registry.register_function(
    "abbreviate_currency_columns", abbreviate_currency_columns
)
