...
class Defaults:
    ...
    DATABRICKS_SOCKET_TIMEOUT_S = 900.0
    DATABRICKS_RETRY_MAX_ATTEMPTS = 30
    DATABRICKS_RETRY_MAX_DURATION_S = 900.0
    DATABRICKS_RETRY_DELAY_MIN_S = 1.0
    DATABRICKS_RETRY_DELAY_MAX_S = 60.0
    REDSHIFT_PORT = 5439
...
class ErrorMessages:
    ...
    MISSING_DEPENDENCY = (
        "{package} is required for {feature}. Install: pip install {package}"
    )
...
class Environment:
    ...
    DATABRICKS_SERVING_BASE_URL = "DATABRICKS_SERVING_BASE_URL"
    ...
    REDSHIFT_ACCESS_KEY_ID = "REDSHIFT_ACCESS_KEY_ID"
    REDSHIFT_SECRET_ACCESS_KEY = "REDSHIFT_SECRET_ACCESS_KEY"
    REDSHIFT_SESSION_TOKEN = "REDSHIFT_SESSION_TOKEN"
    REDSHIFT_SERVERLESS_ACCT_ID = "REDSHIFT_SERVERLESS_ACCT_ID"
    REDSHIFT_SERVERLESS_WORK_GROUP = "REDSHIFT_SERVERLESS_WORK_GROUP"
    REDSHIFT_SSL = "REDSHIFT_SSL"
    ...
    SLIDEFLOW_DATABRICKS_SOCKET_TIMEOUT_S = "SLIDEFLOW_DATABRICKS_SOCKET_TIMEOUT_S"
    SLIDEFLOW_DATABRICKS_RETRY_MAX_ATTEMPTS = "SLIDEFLOW_DATABRICKS_RETRY_MAX_ATTEMPTS"
    SLIDEFLOW_DATABRICKS_RETRY_MAX_DURATION_S = (
        "SLIDEFLOW_DATABRICKS_RETRY_MAX_DURATION_S"
    )
    SLIDEFLOW_DATABRICKS_RETRY_DELAY_MIN_S = "SLIDEFLOW_DATABRICKS_RETRY_DELAY_MIN_S"
    SLIDEFLOW_DATABRICKS_RETRY_DELAY_MAX_S = "SLIDEFLOW_DATABRICKS_RETRY_DELAY_MAX_S"
